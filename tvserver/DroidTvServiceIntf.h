...
public:
    ...
    int atvManualScan(int32_t startFreq, int32_t endFreq, int32_t videoStd, int32_t audioStd);
    ...
    int updateRRT(int freq, int modulation, int mode);
    int updateEAS(int freq, int modulation, int mode);
