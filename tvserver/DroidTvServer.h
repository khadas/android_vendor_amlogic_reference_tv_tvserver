...
public:
    ...
    Return<int32_t> atvManualScan(int32_t startFreq, int32_t endFreq, int32_t videoStd, int32_t audioStd) override;
    ...
    Return<int32_t> GetVRREnable() override;
    Return<int32_t> GetVRRMode() override;
    Return<int32_t> GetAllmInfo() override;
    ...
    Return<int32_t> updateRRT(int32_t freq, int32_t module, int32_t mode) override;
    Return<int32_t> updateEAS(int32_t freq, int32_t module, int32_t mode) override;
