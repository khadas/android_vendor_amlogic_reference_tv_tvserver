 ...
 *  - 1 droidlogic tvserver daemon, hardware binder implementation
 */
...
Return<int32_t> DroidTvServer::atvManualScan(int32_t startFreq, int32_t endFreq, int32_t videoStd, int32_t audioStd) {
    return mTvServiceIntf->atvManualScan(startFreq, endFreq, videoStd, audioStd);
}
...
Return<int32_t> DroidTvServer::Tv_SetDLGEnable(int32_t isEnable) {
    int ret = -1;
    if ( isEnable != 0 ) {
        ret = mTvServiceIntf->Tv_SetDLGEnable(true);
    } else {
        ret = mTvServiceIntf->Tv_SetDLGEnable(false);
    }
    return ret;
}
...
Return<int32_t> DroidTvServer::SetVRREnable(int32_t isEnable) {
    int ret = -1;
    if (isEnable != 0) {
        ret = mTvServiceIntf->SetVRREnable(true);
    } else {
        ret = mTvServiceIntf->SetVRREnable(false);
    }
    return ret;
}

Return<int32_t> DroidTvServer::GetVRRMode() {
    return mTvServiceIntf->GetVRRMode();
}

Return<int32_t> DroidTvServer::GetVRREnable() {
    return mTvServiceIntf->GetVRREnable();
}

Return<int32_t> DroidTvServer::GetAllmInfo() {
    return mTvServiceIntf->GetAllmInfo();
}
...
Return<int32_t> DroidTvServer::updateRRT(int32_t freq, int32_t module, int32_t mode) {
    return mTvServiceIntf->updateRRT(freq, module, mode);
}

Return<int32_t> DroidTvServer::updateEAS(int32_t freq, int32_t module, int32_t mode) {
    return mTvServiceIntf->updateEAS(freq, module, mode);
}
...
Return<void> DroidTvServer::getBasicVdecStatusInfo(int32_t vdecId, getBasicVdecStatusInfo_cb _hidl_cb) {
    BasicVdecState info;
    mTvServiceIntf->getBasicVdecStatusInfo(vdecId, info.decode_time_cost, info.frame_width, info.frame_height, info.frame_rate,
    info.error_count, info.frame_count, info.error_frame_count, info.drop_frame_count, info.double_write_mode);
    _hidl_cb(info);
    return Void();
}
