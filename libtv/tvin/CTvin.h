...
//AFE
static const char *PATH_AFE_DPHASE_EN_49              = "/sys/module/tvin_afe/parameters/enable_dphase";
...
public:
    ...
    static void tvin_onResPreemptCallback(void* param);
