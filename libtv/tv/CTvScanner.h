...
public:
    /** ATSC Antenna type */
    static const int AM_ATSC_ANTENNA_TYPE_AIR = 1;
    static const int AM_ATSC_ANTENNA_TYPE_CABLE_STD = 2;
    static const int AM_ATSC_ANTENNA_TYPE_CABLE_IRC = 3;
    static const int AM_ATSC_ANTENNA_TYPE_CABLE_HRC = 4;
    CTvScanner();
    ~CTvScanner();
...
private:
    ...
    int getAtscChannelPara(int antennaType, Vector<sp<CTvChannel> > &vcp);
